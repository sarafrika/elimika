...
@Tag(name = "Revenue Analytics (Legacy)", description = "Deprecated revenue dashboard endpoints")
@RequiredArgsConstructor
public class LegacyRevenueController {
    ...
    @Operation(summary = "[Deprecated] Get revenue dashboard analytics")

...
public record ClassMarketplaceJobRequestDTO(
        ...
        @Schema(description = "**[REQUIRED]** Default end date-time for the advertised class (UTC). Together with default_start_time this fixes the class length.", requiredMode = Schema.RequiredMode.REQUIRED)

...
public enum NotificationType {
    ...
    ASSIGNMENT_DEADLINE_REMINDER("ASSIGNMENT_DEADLINE_REMINDER", "assignment-deadline-reminder", "Assignment Deadline", NotificationCategory.ASSIGNMENTS_GRADING),
    ASSESSMENT_COMPLETED("ASSESSMENT_COMPLETED", "assessment-completed", "Assessment Completed", NotificationCategory.ASSIGNMENTS_GRADING),
    ...
    COURSE_CONTENT_APPROVED("COURSE_CONTENT_APPROVED", "course-content-approved", "Course Approved", NotificationCategory.COURSE_MANAGEMENT),
    COURSE_CONTENT_REJECTED("COURSE_CONTENT_REJECTED", "course-content-rejected", "Course Rejected", NotificationCategory.COURSE_MANAGEMENT),
    PROGRAM_CONTENT_APPROVED("PROGRAM_CONTENT_APPROVED", "program-content-approved", "Program Approved", NotificationCategory.COURSE_MANAGEMENT),
    ...
    TRAINING_RATE_UPDATE_SUBMITTED("TRAINING_RATE_UPDATE_SUBMITTED", "training-rate-update-submitted", "Rate Update Submitted", NotificationCategory.COURSE_MANAGEMENT),
    TRAINING_RATE_UPDATE_APPROVED("TRAINING_RATE_UPDATE_APPROVED", "training-rate-update-decision", "Rate Update Approved", NotificationCategory.COURSE_MANAGEMENT),
    TRAINING_RATE_UPDATE_REJECTED("TRAINING_RATE_UPDATE_REJECTED", "training-rate-update-decision", "Rate Update Rejected", NotificationCategory.COURSE_MANAGEMENT),
    ...
    CLASS_MARKETPLACE_JOB_APPLICATION_HIRED("CLASS_MARKETPLACE_JOB_APPLICATION_HIRED", "class-marketplace-job-hired", "You've Been Hired", NotificationCategory.COURSE_MANAGEMENT),

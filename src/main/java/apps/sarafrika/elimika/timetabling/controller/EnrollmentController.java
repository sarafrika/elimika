...
public class EnrollmentController {
    ...
    @PreAuthorize("isOwner(#enrollmentUuid) or hasRole('INSTRUCTOR') or hasRole('ORGANIZATION_ADMIN')")
    ...
    @PreAuthorize("isOwner(#studentUuid) or hasRole('INSTRUCTOR') or hasRole('ORGANIZATION_ADMIN')")

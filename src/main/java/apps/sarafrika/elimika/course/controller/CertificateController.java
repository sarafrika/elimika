...
public class CertificateController {
    ...
    @PostMapping
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<CertificateDTO>> createCertificate(
    ...
    @GetMapping("/{uuid}")
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<CertificateDTO>> getCertificateByUuid(
    ...
    @GetMapping
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<PagedDTO<CertificateDTO>>> getAllCertificates(
            Pageable pageable) {
    ...
    @PutMapping("/{uuid}")
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<CertificateDTO>> updateCertificate(
            @PathVariable UUID uuid,
            @Valid @RequestBody CertificateDTO certificateDTO) {
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<CertificateDTO>> generateCourseCertificate(
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<CertificateDTO>> generateProgramCertificate(
            @RequestParam UUID studentUuid,
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<Boolean>> verifyCertificate(
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<CertificateDTO>> getCertificateByNumber(
            @PathVariable String certificateNumber) {
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<String>> revokeCertificate(
            @PathVariable UUID uuid,
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<CertificateDTO>> generateCertificateUrl(
            @PathVariable UUID uuid,
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<List<CertificateDTO>>> getStudentCertificates(
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<List<CertificateDTO>>> getDownloadableCertificates(
            @PathVariable UUID studentUuid) {
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<List<CertificateDTO>>> getCourseCertificates() {
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<List<CertificateDTO>>> getProgramCertificates() {
    ...
    @GetMapping("/revoked")
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<List<CertificateDTO>>> getRevokedCertificates() {
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<CertificateTemplateDTO>> createCertificateTemplate(
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<PagedDTO<CertificateTemplateDTO>>> getCertificateTemplates(
            Pageable pageable) {
    ...
    public ResponseEntity<apps.sarafrika.elimika.common.dto.ApiResponse<CertificateTemplateDTO>> updateCertificateTemplate(

...
/**
 * Data Transfer Object representing a training program delivery application.
 */
@Schema(
        name = "ProgramTrainingApplication",
...
public record ProgramTrainingApplicationDTO(
        ...
        @Schema(
                ...
                allowableValues = {"pending", "approved", "rejected", "revoked"},
                accessMode = Schema.AccessMode.READ_ONLY
        )

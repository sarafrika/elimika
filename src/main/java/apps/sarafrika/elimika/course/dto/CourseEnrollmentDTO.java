...
/**
 * Course Enrollment Data Transfer Object
 * <p>
 * Represents student enrollments in courses within the Sarafrika Elimika system,
 * tracking enrollment status, progress, and completion information.
 *
...
public record CourseEnrollmentDTO(
    ...
    public String getEnrollmentCategory() {
        ...
        return switch (status) {
            case ACTIVE -> "Active Enrollment";
            case COMPLETED -> "Completed Enrollment";
            case DROPPED -> "Dropped Enrollment";
            case SUSPENDED -> "Suspended Enrollment";
        };
    }
    ...
    public String getStatusSummary() {
        return switch (status) {
            ...
            case COMPLETED -> {
                ...
                yield "Successfully completed" + grade;
            }
            case DROPPED -> "Student dropped from course";
            case SUSPENDED -> "Enrollment temporarily suspended";
        };
    }
}
...
public record AssignmentSubmissionAttachmentDTO(
    ...
    public String fileUrl() {
        String storedPath = resolveStoredPath(storedFilename, fileUrl, "/api/v1/assignments/submission-media/");
        return storedPath == null ? fileUrl : "/api/v1/assignments/submission-media/" + storedPath;
    }

...
/**
 * Request payload used by an applicant to update their own PENDING course training application.
 */
@Schema(
        name = "CourseTrainingApplicationUpdateRequest",
        description = "Payload for an applicant editing the rate card or notes on a pending course training application",
        example = """
        {
          "rate_card": {
            "currency": "KES",
...
public record CourseTrainingApplicationUpdateRequest(

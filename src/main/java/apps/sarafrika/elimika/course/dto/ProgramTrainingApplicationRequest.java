...
/**
 * Request payload for submitting a training program delivery application.
 */
@Schema(
        name = "ProgramTrainingApplicationRequest",
...
public record ProgramTrainingApplicationRequest(

...
public class SystemConfigController {
    ...
    public ResponseEntity<apps.sarafrika.elimika.shared.dto.ApiResponse<PagedDTO<CategoryDTO>>> getAllCategories(
            Pageable pageable) {
    ...
    public ResponseEntity<apps.sarafrika.elimika.shared.dto.ApiResponse<List<CategoryDTO>>> getRootCategories() {
    ...
    public ResponseEntity<apps.sarafrika.elimika.shared.dto.ApiResponse<List<CategoryDTO>>> getSubCategories(
    ...
    public ResponseEntity<apps.sarafrika.elimika.shared.dto.ApiResponse<CategoryDTO>> getCategoryByUuid(
    ...
    public ResponseEntity<apps.sarafrika.elimika.shared.dto.ApiResponse<PagedDTO<ContentTypeDTO>>> getAllContentTypes(
            Pageable pageable) {
    ...
    public ResponseEntity<apps.sarafrika.elimika.shared.dto.ApiResponse<List<ContentTypeDTO>>> getMediaContentTypes() {
    ...
    public ResponseEntity<apps.sarafrika.elimika.shared.dto.ApiResponse<Boolean>> checkMimeTypeSupport(
    ...
    public ResponseEntity<apps.sarafrika.elimika.shared.dto.ApiResponse<List<DifficultyLevelDTO>>> getAllDifficultyLevels() {
    ...
    public ResponseEntity<apps.sarafrika.elimika.shared.dto.ApiResponse<PagedDTO<GradingLevelDTO>>> getAllGradingLevels(
            Pageable pageable) {
    ...
    public ResponseEntity<apps.sarafrika.elimika.shared.dto.ApiResponse<PagedDTO<CategoryDTO>>> searchCategories(
            @Parameter(
    ...
    public ResponseEntity<apps.sarafrika.elimika.shared.dto.ApiResponse<PagedDTO<ContentTypeDTO>>> searchContentTypes(
            @Parameter(
                    description = "Optional search parameters for filtering",
                    schema = @Schema(type = "object", additionalProperties = Schema.AdditionalPropertiesValue.TRUE),
                    explode = Explode.TRUE

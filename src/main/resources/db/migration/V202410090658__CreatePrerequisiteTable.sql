...
CREATE INDEX idx_prerequisite_course_uuid ON prerequisite (course_uuid);
CREATE INDEX idx_prerequisite_required_course_uuid ON prerequisite (required_for_course_uuid);
CREATE INDEX idx_prerequisite_prerequisite_type_uuid ON prerequisite (prerequisite_type_uuid);
